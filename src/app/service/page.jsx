...
const ServicePage = () => {
    return (
        <div className="overflow-x-hidden">
                            ...
                            <div className="w-full lg:w-1/2 flex flex-col justify-between gap-5 pr-10">
                                <div className="heading3">
                                    ...
                                    <div className="body2 text-secondary mt-4">
                                        The jobs report soundly beat
                                        expectations, with job gains broadly
                                        spread across the economy and about The
                                        jobs report soundly beat expectations,
                                        with job gains broadly spread across the
                                        economy and about
                                    </div>
                                </div>
                            </div>
            ...
            <Partner className="lg:mt-25 sm:mt-16 mt-10" />
            <footer id="footer">
                <Footer />
            </footer>
        </div>
