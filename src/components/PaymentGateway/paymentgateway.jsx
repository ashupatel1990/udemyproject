...
const Paymentgateway = () => {
    ...
    return (
        <section className="payment-gateway-one style-first lg:mt-25 sm:mt-16 mt-10 bg-surface relative bg-slate-300">
            <div className="bg-img lg:absolute top-0 left-0 lg:w-1/2 w-full h-full shrink-0">
                <Image 
            ...
            <div className="container w-full lg:py-37.5 pt-14 py-16">
                <div className="w-full flex items-center lg:justify-end" ref={ref}>
                    <div className='payment-infor lg:w-1/2 xl:pl-20 lg:pl-10' style={{  transform: isInView ? "none" : 'translateY(60px)', 
            opacity: isInView ? 1 : 0, transition: 'all 0.7s cubic-bezier(0.17, 0.55, 0.55,1) 0.3s', }} >
                        ...
                        <div className='text lg:mt-14 mt-5'>
                            ...
                            We provide reliable and secure payment gateway services for businesses of all sizes. With our cutting-edge and 24/7 technology, we make it easy for you to accept payments from your customers.
                            </div> 
                        </div>
                        ...
                        <div className='button-block flex items-center max-sm:flex-wrap sm:gap-6 gap-3 lg:mt-12 mt-8 w-fit'>
                            ...
                            <div className='relative'>
                                ...
                                <Image
                                    ...
                                    className='absolute -right-12 w-25 h-auto top-1/2 -translate-y-1/2' width={4000} height={4000} alt="img"
                                />
                            </div>
